 ...
 */
public final class HonoServerMessageFilter extends BaseMessageFilter {

    private static final Logger LOG = LoggerFactory.getLogger(HonoServerMessageFilter.class);

    private HonoServerMessageFilter() {
