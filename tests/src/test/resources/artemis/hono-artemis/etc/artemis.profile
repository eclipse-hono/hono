...
ARTEMIS_INSTANCE='/var/lib/hono-artemis'
ARTEMIS_DATA_DIR='/var/lib/hono-artemis/data'
ARTEMIS_ETC_DIR='/var/lib/hono-artemis/etc'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/var/lib/hono-artemis/'
ARTEMIS_INSTANCE_ETC_URI='file:/var/lib/hono-artemis/etc/'
...
# Java Opts
JAVA_ARGS=" -XX:+PrintClassHistogram -XX:+UseG1GC -Xms128M -Xmx360M -Dhawtio.realm=activemq  -Dhawtio.offline="true" -Dhawtio.role=amq -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml"
