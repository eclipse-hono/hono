...
/**
 * Options for configuring Kafka consumers.
 * <p>
...
public interface KafkaConsumerOptions {
    ...
    /**
     * The optional timeout for polling records.
     *
     * @return The maximum number of milliseconds to wait or an empty Optional.
     */
    OptionalLong pollTimeout();
}
