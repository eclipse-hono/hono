...
/**
 * Tests verifying behavior of {@link ProtonBasedDeviceConnectionClient}.
 *
 */
@ExtendWith(VertxExtension.class)
public class ProtonBasedDeviceConnectionClientTest {

    private HonoConnection connection;
    private ProtonSender sender;
    private ProtonReceiver receiver;
    private ProtonBasedDeviceConnectionClient client;
    private Span span;
    private Vertx vertx;
    ...
    public void testGetLastKnownGatewayForDeviceSuccess(final VertxTestContext ctx) {
        ...
        client.getLastKnownGatewayForDevice("tenant", "deviceId", span.context())
    ...
    public void testSetCommandHandlingAdapterInstance(final VertxTestContext ctx) {
        ...
        client.setCommandHandlingAdapterInstance("tenant", "deviceId", "adapterInstanceId", null, span.context())
                .onComplete(ctx.succeeding(r -> {
                    ctx.verify(() -> {
                        // THEN the response has been handled and the span is finished
                        verify(span).finish();
    ...
    public void testRemoveCommandHandlingAdapterInstance(final VertxTestContext ctx) {
        ...
        client.removeCommandHandlingAdapterInstance("tenant", "deviceId", "adapterInstanceId", span.context())
                .onComplete(ctx.succeeding(r -> {
                    ctx.verify(() -> {
                        // THEN the response has been handled and the span is finished
                        verify(span).finish();
    ...
    public void testGetCommandHandlingAdapterInstances(final VertxTestContext ctx) {
        ...
        client.getCommandHandlingAdapterInstances("tenant", deviceId, Collections.emptyList(), span.context())
                .onComplete(ctx.succeeding(resultJson -> {
                    ctx.verify(() -> {
                        // THEN the response has been handled and the span is finished
    ...
    public void testRemoveCommandHandlingAdapterInstanceForNotFoundEntry(final VertxTestContext ctx) {
        ...
        // WHEN removing the command handling adapter instance
        client.removeCommandHandlingAdapterInstance("tenant", "deviceId", "gatewayId", span.context())
                .onComplete(ctx.failing(t -> {
                    ctx.verify(() -> {
                        // THEN the response has been handled and the span is finished
    ...
    public void testSetCommandHandlingAdapterInstanceWithLifespanIncludesRequiredInformationInRequest() {
        ...
        // WHEN setting the command handling adapter instance
        client.setCommandHandlingAdapterInstance("tenant", deviceId, "adapterInstanceId",
    ...
    public void testGetCommandHandlingAdapterInstancesIncludesRequiredInformationInRequest() {
        ...
        // WHEN getting last known gateway information
        client.getCommandHandlingAdapterInstances("tenant", deviceId, Collections.singletonList(gatewayId), span.context());
