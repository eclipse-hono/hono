...
//TODO discuss if we need this at all and how it should work in case we do

/**
 * A utility for creating and validating JWT tokens asserting the tenant status .
 *
 */
public interface TenantAssertionHelper {
