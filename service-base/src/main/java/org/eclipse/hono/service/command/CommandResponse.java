...
public final class CommandResponse {
     ...
     * @return The response or {@code null} if the request ID could not be parsed or if the
     *         status code is &lt; 200 or &gt;= 600.
     * @throws NullPointerException if the request ID is {@code null}.
     */
    public static CommandResponse from(final String requestId, final Buffer payload, final int status) {
