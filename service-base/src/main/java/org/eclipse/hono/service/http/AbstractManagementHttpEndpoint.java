 ...
 */
public abstract class AbstractManagementHttpEndpoint<T extends ServiceConfigProperties> extends AbstractEndpoint
     ...
     */
    public AbstractManagementHttpEndpoint(final Vertx vertx) {
        super(vertx);
    }
