...
| `HONO_AUTH_AMQP_MAX_INSTANCES`<br>`--hono.auth.amqp.maxInstances` | no | *#CPU cores* | The number of verticle instances to deploy. If not set, one verticle per processor core is deployed. |
