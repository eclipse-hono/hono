...
> -e 'HONO_CLIENT_USERNAME=mqtt-adapter' -e 'HONO_CLIENT_PASSWORD=secret' \
> -e 'HONO_CLIENT_TRUST_STORE_PATH=/etc/hono/certs/trusted-certs.pem' \
> -e 'HONO_MQTT_INSECURE_PORT_ENABLED=true' -e 'HONO_MQTT_INSECURE_PORT_BIND_ADDRESS=0.0.0.0'
...
~~~sh
~/hono/adapters/mqtt-vertx$ mvn spring-boot:run -Drun.arguments=--hono.client.host=hono,--hono.client.username=mqtt-adapter,--hono.client.password=secret,--hono.mqtt.insecurePortEnabled=true,--hono.mqtt.insecurePortBindAddress=0.0.0.0
~~~
