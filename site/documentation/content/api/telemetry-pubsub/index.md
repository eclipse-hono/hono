...
| *client_ip*     | no              | *string*    | The client IP address as observed by the protocol adapter. The value is the textual representation of an IPv4 address (see [RFC 791](https://www.rfc-editor.org/rfc/rfc791)) or IPv6 address (see [RFC 5952](https://www.rfc-editor.org/rfc/rfc5952)). |
