...
Clients are not required to verify the validity of trust anchors using the *not-before* and *not-after* properties since the response to the Tenant API *get* request will only return valid trust anchors.
