...
| `HONO_KURA_CLIENTIP_ENABLED`<br>`hono.kura.clientIp.enabled` | no | `false` | If set to `true` the protocol adapter includes a `client_ip` property in downstream messages. |
