...
| `HONO_AMQP_CLIENTIP_ENABLED`<br>`hono.amqp.clientIp.enabled` | no | `false` | If set to `true` the protocol adapter includes a `client_ip` property in downstream messages. |
