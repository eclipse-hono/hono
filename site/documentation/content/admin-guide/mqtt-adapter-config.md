...
| `HONO_MQTT_CLIENTIP_ENABLED`<br>`hono.mqtt.clientIp.enabled` | no | `false` | If set to `true` the protocol adapter includes a `client_ip` property in downstream messages. |
