...
| `HONO_MONGODB_SERVER_SELECTION_TIMEOUT_IN_MS`<br>`--hono.mongodb.serverSelectionTimeoutInMs` | no | `30000` | The time in milliseconds that the mongo driver will wait to select a server for an operation before raising an error.|
