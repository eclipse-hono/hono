...
public final class Constants {
    ...
    /**
     * The header name defined for setting the <em>notification command</em> that is sent to the device.
     */
    public static final String HEADER_NOTIFY_COMMAND = "hono-notify";
