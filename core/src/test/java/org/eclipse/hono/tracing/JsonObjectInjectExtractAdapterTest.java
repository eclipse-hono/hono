...
public class JsonObjectInjectExtractAdapterTest {
    ...
    private static final String PROPERTIES_OBJECT_KEY = "PROPERTIES_OBJECT_KEY";
    ...
    public void testInjectAndExtract() {
        ...
        final JsonObjectInjectAdapter injectAdapter = new JsonObjectInjectAdapter(jsonObject, PROPERTIES_OBJECT_KEY);
        testEntries.forEach((key, value) -> {
            injectAdapter.put(key, value);
        });

        final JsonObjectExtractAdapter extractAdapter = new JsonObjectExtractAdapter(jsonObject, PROPERTIES_OBJECT_KEY);
