...
class CommandRouterServiceImplTest {
    ...
    void setUp() {
        ...
        when(commandConsumerFactory.createCommandConsumer(anyString(), any())).thenReturn(Future.succeededFuture());
        ...
        service.setConfig(new CommandRouterServiceConfigProperties());
