    ...
    public final Future<OperationResult<Void>> updateCredentials(
        ...
        return this.tenantInformationService
                ...
                .compose(result -> {
                    ...
                    if (result.isError()) {
                        return Future.failedFuture(new ServiceInvocationException(
                                tenantId,
                                result.getStatus(),
                ...
                .recover(t -> Future.succeededFuture(DeviceRegistryUtils.mapErrorToResult(t, span)));
    }
    ...
    public final Future<OperationResult<List<CommonCredential>>> readCredentials(
        ...
        return this.tenantInformationService
                ...
                .compose(result -> result.isError()
                        ? Future.failedFuture(new ServiceInvocationException(
                                tenantId,
                                result.getStatus(),
                                "tenant does not exist",
                                null))
