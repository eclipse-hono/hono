...
2. Hono's [AMQP protocol adapter](https://eclipse.dev/hono/docs/user-guide/amqp-adapter/).
...
Please refer to [Getting Started](https://eclipse.dev/hono/docs/getting-started/) and the
[AMQP Adapter User Guide](https://eclipse.dev/hono/docs/user-guide/amqp-adapter/).
