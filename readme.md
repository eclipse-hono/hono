...
Please check out the [Hono project home page](https://projects.eclipse.org/projects/iot.hono) for details. We are also available on `#hono` IRC channel on Freenode and [Hono Dev mailing list](https://dev.eclipse.org/mailman/listinfo/hono-dev).
