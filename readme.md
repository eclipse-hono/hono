![License](https://img.shields.io/github/license/eclipse-hono/hono)
...
[Eclipse Hono](https://eclipse.dev/hono) provides uniform (remote) service interfaces for connecting large
...
Please refer to the [Getting Started guide](https://eclipse.dev/hono/docs/getting-started/) on the project web site.

## Running Hono

Eclipse Hono consists of multiple micro service components provided as container images. Please refer to the
[Admin Guide](https://eclipse.dev/hono/docs/admin-guide/) and
[User Guide](https://eclipse.dev/hono/docs/user-guide/) sections on the project web site for details on how
to configure and use these components.

## Using Hono

Please take a look at the [Developer Guide](https://eclipse.dev/hono/docs/dev-guide/) which provides examples of
...
to the corresponding [API documentation pages](https://eclipse.dev/hono/docs/api/) for details.

## Get in Touch

Please check out the [Eclipse Hono project home page](https://eclipse.dev/hono/community/get-in-touch/) for
