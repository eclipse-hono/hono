...
TENANT_MANAGER_SERVER_KEY_STORE=tenantManagerKeyStore.p12
TENANT_MANAGER_SERVER_KEY_STORE_PWD=tenantmanagerkeys
...
create_cert tenant-manager $TENANT_MANAGER_SERVER_KEY_STORE $TENANT_MANAGER_SERVER_KEY_STORE_PWD
