...
AZURE_PROTOCOL_GATEWAY_KEY_STORE=azureProtocolGatewayKeyStore.p12
AZURE_PROTOCOL_GATEWAY_KEY_STORE_PWD=azurekeys
...
create_cert azure-protocol-gateway $AZURE_PROTOCOL_GATEWAY_KEY_STORE $AZURE_PROTOCOL_GATEWAY_KEY_STORE_PWD
